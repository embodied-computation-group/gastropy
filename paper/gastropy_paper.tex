...
and processing (including ICA-based spatial denoising), time-domain
preprocessing (Hampel filtering, MAD outlier removal, LMMSE movement artifact
attenuation), phase-based artifact detection, time-frequency decomposition,
and phase-locking value (PLV) computation. Named method variants (e.g.,
\texttt{dalmaijer2025}) provide citable, reproducible preprocessing pipelines.
A dedicated neuroimaging sub-module supports scanner trigger alignment,
confound regression, voxelwise BOLD phase extraction, and whole-brain PLV map
generation for concurrent EGG-fMRI data.
...
gastric network if not properly controlled. \citet{Berther2026} used
high-resolution MEG and high-density EGG to provide the first comprehensive
spatiotemporal mapping of gastric-brain coupling at rest, revealing broadband
phase-amplitude coupling across delta, theta, alpha, and beta bands and
identifying distinct spatiospectral fingerprints that overlap with the
fMRI-based gastric network. Most recently,
...
Multi-channel processing & ICA + best-ch & No & N/A & No \\
Preprocessing filters & Hampel/MAD/LMMSE & General & EEG-focused & No \\
ICA denoising & Yes (FastICA) & No & Yes (EEG) & No \\
Phase artifact detection & Yes & No & EEG-focused & No \\
Gastric-brain coupling & PLV + surr. & No & No & PLV \\
Named method variants & Yes & No & N/A & No \\
...
GastroPy maintains a comprehensive automated test suite of 297 tests covering
...
platforms via GitHub Actions. The automated test suite of 297 tests provides
...
the \texttt{gastropy.io} module. Fourth, while the current release includes ICA-based spatial denoising for
multi-channel recordings and three composable time-domain preprocessing
filters, the phase-based artifact detection approach operates at the cycle
